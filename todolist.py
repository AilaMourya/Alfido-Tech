...
class todo:
    def __init__(self, root):
        ...
        self.label2=Label(self.root, text='Add Task',font='ariel, 19 bold',width=10,bd=5,bg='blue',fg='black')
        self.label2.place(x=40,y=55)
        self.label3=Label(self.root, text=' Tasks',font='ariel, 19 bold',width=10,bd=5,bg='blue',fg='black')
